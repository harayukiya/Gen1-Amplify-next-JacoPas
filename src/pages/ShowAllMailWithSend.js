                  ...
                  <tbody>
                    {mails.map((mail, index) => (
                      <tr key={index}>
                        ...
                        <td><button><a href={`https://auiy4zpd02.execute-api.ap-northeast-1.amazonaws.com/default/abic-main-ope-lambda-email-sending01?id=${mail.id_mail}`}>送信</a></button></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
